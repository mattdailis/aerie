...
public record ThreadedTask<T>(Map<SideBySideTest.Cell, CellId> cellMap, Supplier<T> task, TaskThread<T> thread) implements Task<T> {
  public static <T> ThreadedTask<T> of(Executor executor, Map<SideBySideTest.Cell, CellId> cellMap, Supplier<T> task) {
